  ...
  client.on("interactionCreate", async (interaction) => {
    try {
      ...
      if (id.startsWith("candy_click_")) {
        ...
        // كبسة ثانية على نفس البلاصة — نلغيو التحديد
        ...
        console.log(`🍬 ${interaction.user.username}: +${result.totalPoints} points (combo x${result.bestCombo})`);
        return;
      }
