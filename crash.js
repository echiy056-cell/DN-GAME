...
// ============================================
const RANKS = [
  { name: "Legend",   emoji: "🏆", min: 500, label: "LEGEND" },
  { name: "Master",   emoji: "🔮", min: 200, label: "MASTER" },
  { name: "Platinum", emoji: "💎", min: 120, label: "PLATINUM" },
  { name: "Gold",     emoji: "🟡", min: 50,  label: "GOLD" },
  { name: "Silver",   emoji: "⚪", min: 25,  label: "SILVER" },
  { name: "Bronze",   emoji: "🟤", min: 0,   label: "BRONZE" },
];
...
//   HELPERS
// ============================================
function addSignature(container, guild) {
...
function buildStatsEmbed(userId, displayUser, guild) {
  ...
  embed.addFields(
    ...
    { name: "📝 Words", value: `\`${user.totalWords}\``, inline: true },
    ...
    { name: "🔥 Best Streak", value: `\`${user.bestStreak}\``, inline: true }
  );
