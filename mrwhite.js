...
function buildSetupContainer(game) {
  ...
  container.addTextDisplayComponents(
    new TextDisplayBuilder().setContent("## 🎭 Mr. White Game")
  );
  ...
  client.on("interactionCreate", async (interaction) => {
    try {
      ...
      if (id.startsWith("mrwhite_start_")) {
        ...
        console.log(`🎭 Game started! Mr. White: ${game.players[randomIndex].username}`);
        console.log(`🎭 Word: ${game.word}`);
        console.log(`🎭 DM sent to: ${dmSent}/${game.players.length}`);
