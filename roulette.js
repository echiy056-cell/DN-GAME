...
const PICK_MEMBER_TIMEOUT = 5 * 1000;
const CHOOSE_TIMEOUT      = 30 * 1000;
const NEXT_ROUND_TIMEOUT  = 3 * 1000;
...
async function drawWinnerImage(winner) {
  ...
  const avatarX = width * 0.5;       // وسط أفقي
  const avatarY = height * 0.5;      // وسط عمودي
  const avatarRadius = width * 0.08; // 8% من العرض
